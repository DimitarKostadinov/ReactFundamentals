...
async function getPage(page) {
    const res = await fetch(host + 'hotels/all?page=' +page) //Page за paginatora
    return await res.json();
}
...
export { register, login,createHotel ,getPage,getDetails,getReviews,postReview,deleteHotel};